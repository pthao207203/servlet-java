...
@WebServlet(name = "Teacher", urlPatterns = {Constant.URL_TEACHER_ADD, Constant.URL_TEACHER_DELETE, Constant.URL_TEACHER_EDIT})
public class TeacherServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		case Constant.URL_TEACHER_EDIT: {
	...
	private void editTeacher(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		boolean isSuccess = teacherService.editTeacher(id, teacher);
